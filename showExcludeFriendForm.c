...
// Description: showExcludeFriendForm() primary function source file 
// Date: 14/02/2005
//=================================================================//
...
static const char rcsid [] = "$Id: showExcludeFriendForm.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
...
int main (int argc, char **argv)
{
  ...
  mlCgiFreeResources ();
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Relationship System - Form to exclude a friendship relation</TITLE>\n");
    printf ("  </HEAD>\n");
    ...
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORM TO EXCLUDE A FRIENDSHIP RELATION</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/excludeFriend.cgi\" METHOD=\"post\">\n");
    printf ("                      <INPUT TYPE=\"hidden\"   NAME=\"cookieName\" VALUE=\"%s\">\n", cookieName);
    printf ("       <TR><TD>USER ID of who is excluding the friendship relation: </TD> <TD><INPUT TYPE=\"text\"     NAME=\"userId\"     SIZE=\"20\" VALUE=\"%llu\"></TD></TR>\n", (userIdType) strtoul (cookieName, NULL, 10));
    printf ("       <TR><TD>USER ID of friend who is going to be excluded: </TD>       <TD><INPUT TYPE=\"text\"     NAME=\"userId2\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("    </TABLE>\n");  	
    printf ("    <BR><BR>\n");
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Sistema de Relacionamentos - Formul&aacute;rio para excluir amizade</TITLE>\n");
    printf ("  </HEAD>\n");
    printf ("  <BODY BACKGROUND = \"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/images/zertxtr.gif\" BGCOLOR = \"#000000\" TEXT = \"#FFFFFF\" LINK = \"#6699CC\" VLINK = \"#669966\" ALINK = \"#999999\">\n");
    printf ("    <DIV ALIGN = \"CENTER\"><STRONG><FONT FACE = \"Courier New\" SIZE = \"5\" COLOR = \"#FFFFFF\">SISTEMA DE RELACIONAMENTOS</FONT></STRONG></DIV>\n");
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORMUL&Aacute;RIO PARA EXCLUIR AMIZADE</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/excludeFriend.cgi\" METHOD=\"post\">\n");
    printf ("                      <INPUT TYPE=\"hidden\"   NAME=\"cookieName\" VALUE=\"%s\">\n", cookieName);
    printf ("       <TR><TD>ID do usuário que está excluindo a amizade: </TD>     <TD><INPUT TYPE=\"text\"     NAME=\"userId\"     SIZE=\"20\" VALUE=\"%llu\"></TD></TR>\n", (userIdType) strtoul (cookieName, NULL, 10));
    printf ("       <TR><TD>ID do ex-amigo(a): </TD>                              <TD><INPUT TYPE=\"text\"     NAME=\"userId2\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("    </TABLE>\n");  	
    printf ("    <BR><BR>\n");
...
/*$RCSfile: showExcludeFriendForm.c,v $*/
