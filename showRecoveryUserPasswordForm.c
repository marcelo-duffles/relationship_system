...
// Description: showRecoveryUserPasswordForm() primary function source file 
// Date: 16/02/2005
//=================================================================//
 ...
 * $Log: showRecoveryUserPasswordForm.c,v $
...
static const char rcsid [] = "$Id: showRecoveryUserPasswordForm.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
...
int main (int argc, char **argv)
{
  ...
  if ((errorCode = getDataFromId (strtoul (cookieName, NULL, 10), &userData)) != OK)
  {
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Relationship System - Form to recovery user password</TITLE>\n");
    printf ("  </HEAD>\n");
    ...
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORM TO RECOVERY USER PASSWORD</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/recoveryUserPassword.cgi\" METHOD=\"post\">\n");
    printf ("       <TR><TD>Username: </TD>     <TD><INPUT TYPE=\"text\"     NAME=\"username\"   SIZE=\"%i\" VALUE=\"%s\"></TD></TR>\n", MAX_LENGTH_USERNAME, userData.userName);
    printf ("    </TABLE>\n");  	
    printf ("    <BR><BR>\n");
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Sistema de Relacionamentos - Formul&aacute;rio para recuperar senha de usu&aacute;rio</TITLE>\n");
    printf ("  </HEAD>\n");
    printf ("  <BODY BACKGROUND = \"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/images/zertxtr.gif\" BGCOLOR = \"#000000\" TEXT = \"#FFFFFF\" LINK = \"#6699CC\" VLINK = \"#669966\" ALINK = \"#999999\">\n");
    printf ("    <DIV ALIGN = \"CENTER\"><STRONG><FONT FACE = \"Courier New\" SIZE = \"5\" COLOR = \"#FFFFFF\">SISTEMA DE RELACIONAMENTOS</FONT></STRONG></DIV>\n");
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORMUL&Aacute;RIO PARA RECUPERAR SENHA DE USU&Aacute;RIO</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/recoveryUserPassword.cgi\" METHOD=\"post\">\n");
...
/*$RCSfile: showRecoveryUserPasswordForm.c,v $*/
