 ...
 * $Log: removeParentRelationship.c,v $
...
static const char rcsid [] = "$Id: removeParentRelationship.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
...
/*$RCSfile: removeParentRelationship.c,v $*/
