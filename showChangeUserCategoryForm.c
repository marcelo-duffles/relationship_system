...
// Description: showchangeUserCategoryForm() primary function source file 
// Date: 14/02/2005
//=================================================================//
 ...
 * $Log: showChangeUserCategoryForm.c,v $
...
static const char rcsid [] = "$Id: showChangeUserCategoryForm.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
...
int main (int argc, char **argv)
{
  ...
  mlCgiFreeResources ();
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Relationship System - Form to change user category</TITLE>\n");
    printf ("  </HEAD>\n");
    ...
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORM TO CHANGE USER CATEGORY</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/changeUserCategory.cgi\" METHOD=\"post\">\n");
    ...
    printf ("    <BR><BR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <DIV ALIGN=\"center\"><I>If the user is going to change to WEB USER, please fill these form too.</I><BR><BR>\n");
    printf ("    <STRONG>NEW DATA:</STRONG></DIV><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Sistema de Relacionamentos - Formul&aacute;rio para alterar categoria de usu&aacute;rio</TITLE>\n");
    printf ("  </HEAD>\n");
    printf ("  <BODY BACKGROUND = \"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/images/zertxtr.gif\" BGCOLOR = \"#000000\" TEXT = \"#FFFFFF\" LINK = \"#6699CC\" VLINK = \"#669966\" ALINK = \"#999999\">\n");
    printf ("    <DIV ALIGN = \"CENTER\"><STRONG><FONT FACE = \"Courier New\" SIZE = \"5\" COLOR = \"#FFFFFF\">SISTEMA DE RELACIONAMENTOS</FONT></STRONG></DIV>\n");
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORMUL&Aacute;RIO PARA ALTERAR CATEGORIA DE USU&Aacute;RIO</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/changeUserCategory.cgi\" METHOD=\"post\">\n");
    ...
    printf ("    <BR><BR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <DIV ALIGN=\"center\"><I>Se o usu&aacute;rio est&aacute; mudando para USU&Aacute;RIO WEB, por favor preencha o formul&aacute;rio abaixo tamb&eacute;m.</I><BR><BR>\n");
    printf ("    <STRONG>NOVOS DADOS:</STRONG></DIV><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("       <TR><TD>Username: </TD>     <TD><INPUT TYPE=\"text\"     NAME=\"username\"   SIZE=\"%i\"  ></TD></TR>\n", MAX_LENGTH_USERNAME);
...
/*$RCSfile: showChangeUserCategoryForm.c,v $*/
