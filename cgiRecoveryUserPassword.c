...
// Description: cgiRecoveryUserPassword() primary function source file 
// Date: 14/02/2005
//=================================================================//
 ...
 * $Log: cgiRecoveryUserPassword.c,v $
...
static const char rcsid [] = "$Id: cgiRecoveryUserPassword.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
...
int main (int argc, char **argv)
{
  ...
  if ((callerOfProgramId != 0) && (callerOfProgramId != userData.userId))
  {
    showHtmlErrorPage (ONLY_THE_ADMINISTRATOR_CAN_RECOVERY_PASSWORD_OF_OTHERS_USERS);
    exit (ML_CGI_OK);
  }
