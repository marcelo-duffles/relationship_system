...
// Description: showMountFamilyForm() primary function source file 
// Date: 21/02/2005
//=================================================================//
...
int main (int argc, char **argv)
{
  ...
  mlCgiFreeResources ();
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Relationship System - Form to mount family tree</TITLE>\n");
    printf ("  </HEAD>\n");
    ...
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORM TO MOUNT FAMILY TREE</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/mountFamilyTree.cgi\" METHOD=\"post\">\n");
    printf ("                      <INPUT TYPE=\"hidden\"   NAME=\"cookieName\" VALUE=\"%s\">\n", cookieName);
    printf ("       <TR><TD>USER ID of main element: </TD> <TD><INPUT TYPE=\"text\"     NAME=\"userId\"     SIZE=\"20\" VALUE=\"%llu\"></TD></TR>\n", (userIdType) strtoul (cookieName, NULL, 10));
    printf ("       <TR><TD>Lower level: </TD>       <TD><INPUT TYPE=\"text\"     NAME=\"bottom\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("       <TR><TD>Upper level: </TD>       <TD><INPUT TYPE=\"text\"     NAME=\"top\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("    </TABLE>\n");  	
    printf ("    <BR><BR>\n");
    ...
    printf ("<HTML>\n");
    printf ("  <HEAD>\n");
    printf ("    <TITLE>Sistema de Relacionamentos - Formul&aacute;rio para montar &aacute;rvore geneal&oacute;gica</TITLE>\n");
    printf ("  </HEAD>\n");
    printf ("  <BODY BACKGROUND = \"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/images/zertxtr.gif\" BGCOLOR = \"#000000\" TEXT = \"#FFFFFF\" LINK = \"#6699CC\" VLINK = \"#669966\" ALINK = \"#999999\">\n");
    printf ("    <DIV ALIGN = \"CENTER\"><STRONG><FONT FACE = \"Courier New\" SIZE = \"5\" COLOR = \"#FFFFFF\">SISTEMA DE RELACIONAMENTOS</FONT></STRONG></DIV>\n");
    printf ("    <HR>\n");
    printf ("    <CENTER><STRONG><FONT FACE = \"Courier New\" SIZE = \"4\" COLOR = \"#FFFFFF\">FORMUL&Aacute;RIO PARA MONTAR &Aacute;RVORE GENEAL&Oacute;GICA</FONT></STRONG><CENTER>\n");
    printf ("    <HR>\n");
    printf ("    <BR><BR>\n");
    printf ("    <TABLE BORDER=\"1\" ALIGN = \"center\">\n");
    printf ("    <FORM ACTION=\"http://www2.del.ufrj.br/~marceloddm/computacao_ii/pf/cgi/mountFamilyTree.cgi\" METHOD=\"post\">\n");
    printf ("                      <INPUT TYPE=\"hidden\"   NAME=\"cookieName\" VALUE=\"%s\">\n", cookieName);
    printf ("       <TR><TD>ID do elemento principal: </TD>     <TD><INPUT TYPE=\"text\"     NAME=\"userId\"     SIZE=\"20\" VALUE=\"%llu\"></TD></TR>\n", (userIdType) strtoul (cookieName, NULL, 10));
    printf ("       <TR><TD>N&iacute;vel inferior: </TD>        <TD><INPUT TYPE=\"text\"     NAME=\"bottom\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("       <TR><TD>N&iacute;vel superior: </TD>        <TD><INPUT TYPE=\"text\"     NAME=\"top\"    SIZE=\"20\"  ></TD></TR>\n");
    printf ("    </TABLE>\n");  	
    printf ("    <BR><BR>\n");
