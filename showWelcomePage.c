...
// Description: showWelcomePage() function source file 
// Date: 16/02/2005
//=================================================================//
...
static const char rcsid [] = "$Id: showWelcomePage.c,v 1.1 2005/02/16 22:11:21 marceloddm Exp marceloddm $";
